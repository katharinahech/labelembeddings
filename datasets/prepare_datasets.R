...
chaosnli_df <- stream_in(file("datasets/data_raw/chaosNLI_snli.jsonl"))
...
so2sat_votes <- read.csv('datasets/data_raw/so2sat_patterns_16.csv')
...
# load dataset
cifar_df_full <- read.csv('datasets/data_raw/cifar10h-raw.csv')
