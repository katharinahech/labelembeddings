...
chaosnli_samples <- tail(chaosnli_results_full[[4]])
...
so2sat_samples <- tail(so2sat_results_full[[4]])
...
cifar_samples <- cifar_results_full[[2]]
...
chaosnli_mixed_samples <- tail(chaosnli_mixed_results_full[[4]])
